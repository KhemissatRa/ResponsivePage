...
export default function Clients() {
  return (
   ...
   <div className='flex flex-wrap justify-center items-center space-y-8 space-x-4 mx-auto'>
    <img src='src\assets\Logo-grey  (5).png' alt="logo" />
    <img src="src\assets\Logo-grey  (1).png" alt="logo" />
    <img src="src\assets\Logo-grey  (2).png" alt="logo"/>
    <img src="src\assets\Logo-grey  (3).png"  alt="logo"/>
